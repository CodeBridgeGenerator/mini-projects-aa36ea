...
const ReviewsFakerDialogComponent = (props) => {
    ...
    const [taskIdIds, settaskIdIds] = useState();
const [reviewIdIds, setreviewIdIds] = useState();
    ...
    useEffect(() => {
        ...
        client.service("tasks")
                        ...
                        .then((data) => {
                        settaskIdIds(data.data);
                        });
client.service("users")
                        .find({ query: { $select: ["_id","name"] } })
                        .then((data) => {
                        setreviewIdIds(data.data);
                        });
    ...
    const onRun = async () => {
        let fakeData = reviewsFakerFactory(props.user,fakerCount,taskIdIds,reviewIdIds);
