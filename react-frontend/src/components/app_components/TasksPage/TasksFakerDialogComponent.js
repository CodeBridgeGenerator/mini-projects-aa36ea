...
const [claimedByIds, setclaimedByIds] = useState();
    ...
    useEffect(() => {
        ...
        client.service("users")
                        ...
                        .then((data) => {
                        setpostedByIds(data.data);
                        });
client.service("users")
                        .find({ query: { $select: ["_id","name"] } })
                        .then((data) => {
                        setclaimedByIds(data.data);
                        });
    ...
    const onRun = async () => {
        let fakeData = tasksFakerFactory(props.user,fakerCount,postedByIds,claimedByIds);
